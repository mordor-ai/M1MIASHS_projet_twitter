...
def viz_graph(g: Graph, in_out: int, file_name: str, folder: str, layout: str = "auto", show_label_by_degree: int = 0.1,
    ...
    visual_style = {  # Don't curve the edges
        ...
        # ,
        # "vertex_label": [(v[label] if ((1 - v.degree ( ) / max_degree) <= show_label_by_degree) else "") for v
        #                  in g.vs]
